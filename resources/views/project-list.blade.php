                        ...
                        <div class="table-responsive">
                            <table class="table table-hover c_table theme-color">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="{{asset('tem/assets/images/xs/avatar1.jpg')}}" alt="">
                                        </td>
                                        <td>
                                        ...
                                        <td class="hidden-md-down">
                                            <ul class="list-unstyled team-info margin-0">                                               
                                                ...
                                                <li><img src="{{asset('tem/assets/images/xs/avatar4.jpg')}}" alt="Avatar"></li>
                                                <li><img src="{{asset('tem/assets/images/xs/avatar6.jpg')}}" alt="Avatar"></li>
                                            </ul>
                                        </td>
                                        <td class="hidden-md-down">
                                            <div class="progress">
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="{{asset('tem/assets/images/xs/avatar2.jpg')}}" alt="">
                                        </td>
                                        <td>
                                        ...
                                        <td class="hidden-md-down">
                                            <ul class="list-unstyled team-info margin-0">                                               
                                                <li><img src="{{asset('tem/assets/images/xs/avatar5.jpg')}}" alt="Avatar"></li>
                                                <li><img src="{{asset('tem/assets/images/xs/avatar6.jpg')}}" alt="Avatar"></li>
                                            </ul>
                                        </td>
                                        <td class="hidden-md-down">
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="{{asset('tem/assets/images/xs/avatar10.jpg')}}" alt="">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="{{asset('tem/assets/images/xs/avatar4.jpg')}}" alt="">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="{{asset('tem/assets/images/xs/avatar5.jpg')}}" alt="">
                                        </td>
                                        <td>
