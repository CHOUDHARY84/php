                    ...
                    <div class="card">
                        ...
                        <div class="">
                            <ul class="comment-reply list-unstyled">
                                <li>
                                    <div class="icon-box"><img class="img-fluid img-thumbnail" src="{{asset('tem/assets/images/sm/avatar2.jpg')}}" alt="Awesome Image"></div>
                                    <div class="text-box">
                                        <h5>Kareem Todd</h5>
                                ...
                                <li>
                                    <div class="icon-box"><img class="img-fluid img-thumbnail" src="{{asset('tem/assets/images/sm/avatar1.jpg')}}" alt="Awesome Image"></div>
                                    <div class="text-box">
