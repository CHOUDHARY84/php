                                ...
                                <li>
                                    ...
                                    <div class="message my-message">
                                        ...
                                        <div class="attachment">
                                            <a class="w200" href="javascript:void(0);"><img src="{{asset('tem/assets/images/image-gallery/2.jpg')}}" alt="" class="img-fluid img-thumbnail"></a>
                                            <a class="w200" href="javascript:void(0);"><img src="{{asset('tem/assets/images/image-gallery/5.jpg')}}" alt="" class="img-fluid img-thumbnail"></a>
                                        </div>
                                    </div>
                                </li>                        
                                <li>
