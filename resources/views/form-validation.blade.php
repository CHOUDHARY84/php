...
<section class="content">
    <div class="body_scroll">
        ...
        <form action="reginsert" method="post"> 
                                @csrf
                                <label for="email_address">register name</label>
                                <div class="form-group">                                
                                    <input type="text" name="regname" id="reg" class="form-control" placeholder="Enter your name">
                                </div>

                                <label for="password">roll number</label>
                                <div class="form-group">                                
                                    <input type="text" name="regroll" id="password" class="form-control" placeholder="Enter your roll number">
                                </div>
