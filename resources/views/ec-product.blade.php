        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card">
                        <div class="body product_item">
                            ...
                            <img src="{{asset('tem/assets/images/ecommerce/1.png')}}" alt="Product" class="img-fluid cp_img" />
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card">
                        <div class="body product_item">
                            <img src="{{asset('tem/assets/images/ecommerce/2.png')}}" alt="Product" class="img-fluid cp_img" />
                            <div class="product_details">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card">
                        <div class="body product_item">
                            <img src="{{asset('tem/assets/images/ecommerce/3.png')}}" alt="Product" class="img-fluid cp_img" />
                            <div class="product_details">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card">
                        <div class="body product_item">
                            <img src="{{asset('tem/assets/images/ecommerce/4.png')}}" alt="Product" class="img-fluid cp_img" />
                            <div class="product_details">
                                <a href="ec-product-detail.html">Simple Black Clock</a>
                                <ul class="product_price list-unstyled">
                                    <li class="old_price">$16.00</li>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card">
                        <div class="body product_item">
                            ...
                            <img src="{{asset('tem/assets/images/ecommerce/5.png')}}" alt="Product" class="img-fluid cp_img" />
                            <div class="product_details">
                                <a href="ec-product-detail.html">Simple Black Clock</a>
                                <ul class="product_price list-unstyled">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card">
                        <div class="body product_item">
                            ...
                            <img src="{{asset('tem/assets/images/ecommerce/6.png')}}" alt="Product" class="img-fluid cp_img" />
                            <div class="product_details">
                                <a href="ec-product-detail.html">Simple Black Clock</a>
                                <ul class="product_price list-unstyled">
                                    <li class="old_price">$16.00</li>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card">
                        <div class="body product_item">
                            <img src="{{asset('tem/assets/images/ecommerce/7.png')}}" alt="Product" class="img-fluid cp_img" />
                            <div class="product_details">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card">
                        <div class="body product_item">
                            <img src="{{asset('tem/assets/images/ecommerce/8.png')}}" alt="Product" class="img-fluid cp_img" />
                            <div class="product_details">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card">
                        <div class="body product_item">
                            <img src="{{asset('tem/assets/images/ecommerce/9.png')}}" alt="Product" class="img-fluid cp_img" />
                            <div class="product_details">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card">
                        <div class="body product_item">
                            <img src="{{asset('tem/assets/images/ecommerce/10.png')}}" alt="Product" class="img-fluid cp_img" />
                            <div class="product_details">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card">
                        <div class="body product_item">
                            <img src="{{asset('tem/assets/images/ecommerce/11.png')}}" alt="Product" class="img-fluid cp_img" />
                            <div class="product_details">
