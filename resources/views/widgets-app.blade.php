        ...
        <div class="container-fluid">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6">
                    <div class="card mcard_4">                        
                        <div class="body">
                            ...
                            <div class="img">
                                <img src="{{asset('tem/assets/images/lg/avatar1.jpg')}}" class="rounded-circle" alt="profile-image">
                            </div>
                            <div class="user">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6">
                    <div class="card mcard_4">                        
                        <div class="body">
                            ...
                            <div class="img">
                                <img src="{{asset('tem/assets/images/lg/avatar2.jpg')}}" class="rounded-circle" alt="profile-image">
                            </div>
                            <div class="user">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6">
                    <div class="card mcard_4">                        
                        <div class="body">
                            ...
                            <div class="img">
                                <img src="{{asset('tem/assets/images/lg/avatar3.jpg')}}" class="rounded-circle" alt="profile-image">
                            </div>
                            <div class="user">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6">
                    <div class="card mcard_4">                        
                        <div class="body">
                            ...
                            <div class="img">
                                <img src="{{asset('tem/assets/images/lg/avatar4.jpg')}}" class="rounded-circle" alt="profile-image">
                            </div>
                            <div class="user">
                                <h5 class="mt-3 mb-1">Eliana Smith</h5>
                                <small class="text-muted">UI/UX Desiger</small>
                        ...
                        <div class="body">                            
                            ...
                            <ul class="list-unstyled inbox_widget">
                                <li class="d-flex justify-content-start">
                                    <div class="inbox-img">
                                        <img src="{{asset('tem/assets/images/xs/avatar1.jpg')}}" alt="">
                                    </div>
                                ...
                                <li class="d-flex justify-content-start">
                                    <div class="inbox-img">
                                        <img src="{{asset('tem/assets/images/xs/avatar2.jpg')}}" alt="">
                                    </div>
                                    <div class="inbox_info">
                                ...
                                <li class="d-flex justify-content-start">
                                    <div class="inbox-img">
                                        <img src="{{asset('tem/assets/images/xs/avatar3.jpg')}}" alt="">
                                    </div>
                                    <div class="inbox_info">
            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-12">
                    <div class="card">
                        <div class="body">
                            <img class="img-responsive" src="{{asset('tem/assets/images/image-gallery/11.jpg')}}" alt="About the image">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card">                    
                        <div class="body">
                            <img class="img-responsive" src="{{asset('tem/assets/images/image-gallery/10.jpg')}}" alt="About the image">
                            <div class="mt-4 pw_header">
                                <h6>New Dashboard</h6>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card">
                        <div class="body">
                            <img class="img-responsive" src="{{asset('tem/assets/images/image-gallery/12.jpg')}}" alt="About the image">
                            <div class="mt-4 pw_header">
                                <h6>Mobile App</h6>
                        ...
                        <div class="body">
                            <div class="chat-widget">
                                <ul class="list-unstyled">
                                    <li class="left">
                                        <img src="{{asset('tem/assets/images/xs/avatar3.jpg')}}" class="rounded-circle" alt="">
                                    ...
                                    <li class="left">
                                        <img src="{{asset('tem/assets/images/xs/avatar2.jpg')}}" class="rounded-circle" alt="">
                                        <ul class="list-unstyled chat_info">
                                    ...
                                    <li class="left">
                                        <img src="{{asset('tem/assets/images/xs/avatar5.jpg')}}" class="rounded-circle" alt="">
                                        <ul class="list-unstyled chat_info">
                        ...
                        <div class="body carousel slide twitter feed" data-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item text-center active">
                                    <div class="user">
                                        <img src="{{asset('tem/assets/images/xs/avatar1.jpg')}}" alt="avatar" />
            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-12">
                    <div class="card mcard_1">
                        <div class="img">
                            <img src="{{asset('tem/assets/images/image-gallery/2.jpg')}}" class="img-fluid" alt="">
                        </div>
                        <div class="body">
                            <div class="user">
                                <img src="{{asset('tem/assets/images/sm/avatar1.jpg')}}" class="rounded-circle img-raised" alt="profile-image">
                                <h5 class="mt-3 mb-1">Eliana Smith</h5>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card mcard_2">
                        <div class="img">
                            <img src="{{asset('tem/assets/images/image-gallery/3.jpg')}}" class="img-fluid" alt="">
                        </div>
                        <div class="body">
                            <div class="user">
                                <img src="{{asset('tem/assets/images/sm/avatar4.jpg')}}" class="rounded-circle img-raised" alt="profile-image">
                                <div class="details">
                    ...
                    <div class="card mcard_3">
                        ...
                        <div class="body">
                            <div class="member-img">
                                <a href="profile.html"><img src="{{asset('tem/assets/images/sm/avatar3.jpg')}}" class="rounded-circle img-raised" alt="profile-image"></a>
                            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-12">
                    <div class="card small_mcard_1">
                        <div class="user">
                            <img src="{{asset('tem/assets/images/sm/avatar1.jpg')}}" alt="profile-image">
                            <div class="details">                                
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card small_mcard_1">
                        <div class="user">
                            <img src="{{asset('tem/assets/images/sm/avatar2.jpg')}}" alt="profile-image">
                            <div class="details">                                
                                <h6 class="mb-0 mt-2">Eliana Smith</h6>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card small_mcard_1">
                        <div class="user">
                            <img src="{{asset('tem/assets/images/sm/avatar3.jpg')}}" alt="profile-image">
                            <div class="details">                                
                                <h6 class="mb-0 mt-2">Eliana Smith</h6>
                            ...
                            <div id="demo1" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{asset('tem/assets/images/image-gallery/1.jpg')}}" class="img-fluid" alt="">
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div id="demo3" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{asset('tem/assets/images/image-gallery/5.jpg')}}" class="img-fluid" alt="">
                                    ...
                                    <div class="carousel-item">
                                        <img src="{{asset('tem/assets/images/image-gallery/6.jpg')}}" class="img-fluid" alt="">
                                        <div class="carousel-caption">
                                            <h3>New York</h3>
                                    ...
                                    <div class="carousel-item">
                                        <img src="{{asset('tem/assets/images/image-gallery/12.jpg')}}" class="img-fluid" alt="">
                                        <div class="carousel-caption">
                                            <h3>Los Angeles</h3>
