                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover c_table theme-color">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td><img src="{{asset('tem/assets/images/ecommerce/1.png')}}" width="40" alt="Product img"></td>
                                            ...
                                            <tr>
                                                <td>2</td>
                                                <td><img src="{{asset('tem/assets/images/ecommerce/2.png')}}" width="40" alt="Product img"></td>
                                                <td>Brone Candle</td>
                                            ...
                                            <tr>
                                                <td>3</td>
                                                <td><img src="{{asset('tem/assets/images/ecommerce/3.png')}}" width="40" alt="Product img"></td>
                                            ...
                                            <tr>
                                                <td>4</td>
                                                <td><img src="{{asset('tem/assets/images/ecommerce/4.png')}}" width="40" alt="Product img"></td>
