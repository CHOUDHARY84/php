                    ...
                    <div class="card">
                        <div class="blogitem mb-5">
                            <div class="blogitem-image">
                                <a href="blog-details.html"><img src="{{asset('tem/assets/images/image-gallery/5.jpg')}}" alt="blog image"></a>
                        ...
                        <div class="blogitem mb-5">
                            <div class="blogitem-image">
                                <a href="blog-details.html"><img src="assets/images/image-gallery/7.jpg')}}" alt="blog image"></a>
                                <span class="blogitem-date">Monday, December 15, 2018</span>
                            </div>
                            <div class="blogitem-content">
                                <div class="blogitem-header">
                                ...
                                <h5><a href="blog-details.html">WTCR from 2018: new rules, more cars, more races</a></h5>
                        ...
                        <div class="blogitem mb-5">
                            <div class="blogitem-image">
                                <a href="blog-details.html"><img src="{{asset('tem/assets/images/image-gallery/8.jpg')}}" alt="blog image"></a>
                                <span class="blogitem-date">Monday, December 15, 2018</span>
                            </div>
                            <div class="blogitem-content">
                                <div class="blogitem-header">
                                    <div class="blogitem-meta">
                                        <span><i class="zmdi zmdi-account"></i>By <a href="javascript:void(0);">Michael</a></span>
                                        <span><i class="zmdi zmdi-comments"></i><a href="blog-details.html">Comments(13)</a></span>
                                    </div>
                                    <div class="blogitem-share">
                                        <ul class="list-unstyled mb-0">
                                            <li><a href="javascript:void(0);"><i class="zmdi zmdi-facebook-box"></i></a></li>
                                ...
                                <h5><a href="blog-details.html">All photographs are accurate. None of them is the truth</a></h5>
                        ...
                        <div class="blogitem">
                            <div class="blogitem-image">
                                <a href="blog-details.html"><img src="{{asset('tem/assets/images/image-gallery/14.jpg')}}" alt="blog image"></a>
                                <span class="blogitem-date">Monday, December 15, 2018</span>
                            </div>
                            <div class="blogitem-content">
                                <div class="blogitem-header">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <ul class="list-unstyled mb-0 widget-recentpost">
                                <li>
                                    <a href="blog-details.html"><img src="{{asset('tem/assets/images/image-gallery/1.jpg')}}" alt="blog thumbnail"></a>
                                ...
                                <li>
                                    <a href="blog-details.html"><img src="{{asset('tem/assets/images/image-gallery/2.jpg')}}" alt="blog thumbnail"></a>
                                    <div class="recentpost-content">
                                ...
                                <li>
                                    <a href="blog-details.html"><img src="{{asset('tem/assets/images/image-gallery/3.jpg')}}" alt="blog thumbnail"></a>
                                    <div class="recentpost-content">
                                ...
                                <li>
                                    <a href="blog-details.html"><img src="{{asset('tem/assets/images/image-gallery/12.jpg')}}" alt="blog thumbnail"></a>
                                    <div class="recentpost-content">
                                        <a href="blog-details.html">Steps to a successful Business</a>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <ul class="list-unstyled mb-0 instagram-plugin">
                                <li><a href="javascript:void(0);"><img src="{{asset('tem/assets/images/blog/05-img.jpg')}}" alt="image description"></a></li>
                                <li><a href="javascript:void(0);"><img src="{{asset('tem/assets/images/blog/06-img.jpg')}}" alt="image description"></a></li>
                                <li><a href="javascript:void(0);"><img src="{{asset('tem/assets/images/blog/07-img.jpg')}}" alt="image description"></a></li>
                                <li><a href="javascript:void(0);"><img src="{{asset('tem/assets/images/blog/08-img.jpg')}}" alt="image description"></a></li>
                                <li><a href="javascript:void(0);"><img src="{{asset('tem/assets/images/blog/09-img.jpg')}}" alt="image description"></a></li>
                                <li><a href="javascript:void(0);"><img src="{{asset('tem/assets/images/blog/10-img.jpg')}}" alt="image description"></a></li>
                                <li><a href="javascript:void(0);"><img src="{{asset('tem/assets/images/blog/11-img.jpg')}}" alt="image description"></a></li>
                                <li><a href="javascript:void(0);"><img src="{{asset('tem/assets/images/blog/12-img.jpg')}}" alt="image description"></a></li>
                                <li><a href="javascript:void(0);"><img src="{{asset('tem/assets/images/blog/13-img.jpg')}}" alt="image description"></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="card">
