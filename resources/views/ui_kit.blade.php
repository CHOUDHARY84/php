                        ...
                        <div class="body m-b-20">
                            <div class="row">
                                <div class="col-sm-2">
                                    ...
                                    <img src="{{asset('tem/')}}assets/images/lg/avatar1.jpg')}}" alt="Rounded Image" class="rounded">
                                </div>
                                <div class="col-sm-2">
                                    <p class="category">Circle Image</p>
                                    <img src="{{asset('tem/')}}assets/images/lg/avatar1.jpg')}}" alt="Circle Image" class="rounded-circle">
                                </div>
                                <div class="col-sm-2">
                                    <p class="category">Raised</p>
                                    <img src="{{asset('tem/')}}assets/images/lg/avatar1.jpg')}}" alt="Raised Image" class="rounded img-raised">
                                </div>
                                <div class="col-sm-2">
                                    <p class="category">Circle Raised</p>
                                    <img src="{{asset('tem/')}}assets/images/lg/avatar1.jpg')}}" alt="Thumbnail Image" class="rounded-circle img-raised">
                                </div>
                            </div>
                        </div>
                    </div>
