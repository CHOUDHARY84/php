                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover theme-color c_table">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="w70"><img class="w50" src="{{asset('tem/assets/images/ecommerce/1.png')}}" alt=""></td>
                                        <td><a href="javascript:void(0)" class="text-muted">PlayStation 4 1TB (Jet Black)</a></td>
                                        <td>3,432</td>
                                    </tr>
                                    <tr>
                                        <td><img class="w50" src="{{asset('tem/assets/images/ecommerce/2.png')}}" alt=""></td>
                                        <td><a href="javascript:void(0)" class="text-muted">Printed color block T-shirt</a></td>
                                        <td>852</td>
                                    </tr>
                                    <tr>
                                        <td><img class="w50" src="{{asset('tem/assets/images/ecommerce/3.png')}}" alt=""></td>
                                        <td><a href="javascript:void(0)" class="text-muted">Wireless headphones</a></td>
                                        <td>1,321</td>
                                    </tr>
                                    <tr>
                                        <td><img class="w50" src="{{asset('tem/assets/images/ecommerce/4.png')}}" alt=""></td>
                                        <td><a href="javascript:void(0)" class="text-muted">PlayStation 4 1TB (Jet Black)</a></td>
                                        <td>980</td>
                                    </tr>
                                    <tr>
                                        <td><img class="w50" src="{{asset('tem/assets/images/ecommerce/5.png')}}" alt=""></td>
                    ...
                    <div class="card">
                        <div class="body">
                            <ul class="row list-unstyled c_review">
                                <li class="col-12">
                                    <div class="avatar">
                                        <a href="javascript:void(0);"><img class="rounded" src="{{asset('tem/assets/images/sm/avatar2.jpg')}}" alt="user" width="60"></a>
                                    </div>                                
                                ...
                                <li class="col-12">
                                    <div class="avatar">
                                        <a href="javascript:void(0);"><img class="rounded" src="{{asset('tem/assets/images/sm/avatar3.jpg')}}" alt="user" width="60"></a>
                                    </div>                                
                                    <div class="comment-action">
                                ...
                                <li class="col-12">
                                    <div class="avatar">
                                        <a href="javascript:void(0);"><img class="rounded" src="{{asset('tem/assets/images/sm/avatar4.jpg')}}" alt="user" width="60"></a>
                                    </div>                                
                                    <div class="comment-action">
                                ...
                                <li class="col-12">
                                    <div class="avatar">
                                        <a href="javascript:void(0);"><img class="rounded" src="{{asset('tem/assets/images/sm/avatar5.jpg')}}" alt="user" width="60"></a>
                                    </div>                                
                                    <div class="comment-action">
